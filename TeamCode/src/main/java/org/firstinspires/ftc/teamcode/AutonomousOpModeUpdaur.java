...
public class AutonomousOpModeUpdate extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //closeClaw();
            // turn right 90
            //moveDistance((48.0 + robotWidth) *-1);
            moveDistance(-18);
           // rotateCW(ninetyDegrees);
            sleep(250);
            ...
            //read_cone();
            //sleep(250);
            //moveDistance((robotWidth));
            //sleep(250);
            //rotateCCW(ninetyDegrees*2);
            //moveDistance((robotWidth +6));
            //closeClaw();
            //elevatorOne();
            //rotateCW(ninetyDegrees/2);
            //moveDistance((12));
            //sleep(250);
            //openClaw();
            //elevator_level(elevator_first);
            //rotateCW(ninetyDegrees);
            //elevator_level(elevator_min);
            // read cone
            ...
            //moveDistance(robotWidth+1);

            // pick up cone
            /*
            rotateCCW(ninetyDegrees*2);
            sleep(500);
            moveDistance(robotWidth+5);
            //sleep(500);
            closeClaw();
            sleep(500);
